          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                echo $_SESSION['uname'];
                $result1 = mysqli_query($db,"SELECT * FROM `exam_category` e JOIN batches b on b.id=e.bid JOIN student_details s on s.student_batch=b.id where s.student_email=(SELECT email from student where user_name='{$_SESSION['uname']}')");
                ...
                while($row1 = mysqli_fetch_array($result1)){
                  echo "<tr>";
                //   echo "<td><a href='./details.php?id={$row['batch_name']}'>" . $row['batch_name'] . "</td>";
                echo "<td>" . $row1['category'] . "</td>";
                echo "<td>" . $row1['batch_name'] . "</td>";
                echo "<td>" "<input type=button value='take exam' onclick='set_exam_type_session(this.value);>;" "</td>";
    ...
    function set_exam_type_session(exam_category){
        ...
        xmlhttp.onreadystatechange=function(){
            if(xmlhttp.readyState==4 && xmlhttp.status==200){
                window.location="examdash.php";
            }
        };

        xmlhttp.open("GET", "forajax/set_exam_type_session?exam_category="+ exam_category);
        xmlhttp.send(null);
