          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                $result = mysqli_query($db,"SELECT * FROM `exam_category`");
                ...
                while($row = mysqli_fetch_array($result)){
                  ...
                  echo "<td>" . $row['exam_time_in_minutes'] . "</td>";
                  echo "<td><a href='addquestion.php?id={$row['id']}'>Select</a> </td>";
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" placeholder="Exam Category" name='category'>
        </div>
        <div class="form-group">
          <label>Time in minutes</label>
          <input type="text" class="form-control" placeholder="Time in Minutes" name='time'>
        </div>
      </div>
